local error, type, assert, pairs, ipairs, pcall = error, type, assert, pairs, ipairs, pcall
...
local evp = require "ext.github.SkyLothar.lua-resty-jwt.evp"
...
local function get_claim_spec_from_legacy_options(self, options)
  local claim_spec = { }
  local jwt_validators = require "ext.github.SkyLothar.lua-resty-jwt.jwt-validators"
